...
public class ScampiPostSerializer {
    ...
    public static Post postFromMessage(SCAMPIMessage scampiMessage, TopicRepository topicRepository) throws MissingFieldsException, MissingTopicException, DatabaseException {
        ...
        Post post = new Post();
        post.setUuid(scampiMessage.getAppTag());
    ...
    public static SCAMPIMessage messageFromPost(Post post, Topic topic, String creator) {
    ...
    private static boolean messageIsMissingFields(SCAMPIMessage scampiMessage) {
        if(
                scampiMessage.hasString(TYPE_ID_FIELD) &&
